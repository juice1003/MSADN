...
path = [f'H:/Google download/MSADN/MSADN-main/Data_Analysis/each NCY_Test_CSV/test{i}_NCY.csv' for i in range(10)]
y_true = []
y_pred = []
...
# 类别名
class_names = [
    '5S-rRNA', '5.8S-rRNA', 'tRNA', 'Ribozyme', 'CD-box', 'miRNA', 'Intron-gp-I',
...
# 设置图像标题、轴标签、图例
plt.title('ROC Curves on NCY dataset', fontsize=20, fontname='serif')
...
output_image_path = 'H:/Google download/MSADN/MSADN-main/Data_Analysis/ROC&PR curve/ROC_curve_NCY.png'
