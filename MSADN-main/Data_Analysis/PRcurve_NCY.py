...
plt.title('PR Curves on NCY dataset', fontsize=20, fontname='serif')
...
output_image_path = 'H:/Google download/MSADN/MSADN-main/Data_Analysis/ROC&PR curve/PR_curve_NCY.png'
