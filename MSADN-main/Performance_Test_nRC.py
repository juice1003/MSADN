...
with torch.no_grad():
    ...
    for class_id in range(13):  # 有13个类，类标签用0到12表示
        ...
        # class_support = report.get(class_id_str, {}).get('support', 0)
...
Pre_Data.to_csv('H:/Google download/MSADN/MSADN-main/Pred_Data_nRC/myModel_nRC.csv', encoding='gbk')
